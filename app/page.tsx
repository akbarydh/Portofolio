...
export default function Home() {
  ...
  return (
    <main className="relative min-h-screen bg-gray-950 text-white overflow-x-hidden font-sans selection:bg-emerald-500/30">
      ...
      <section className="relative pt-32 pb-20 z-10 min-h-[90vh] flex items-center">
        <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
          <motion.div {...fadeIn}>
            ...
            <p className="mt-6 text-gray-400 text-lg md:text-xl max-w-lg leading-relaxed">
          ...
          >
            <div className="w-80 h-80 relative group">
              ...
              <div className="relative w-full h-full bg-gray-900 border border-emerald-500/20 rounded-[3rem] backdrop-blur-3xl overflow-hidden shadow-2xl">
                <img 
                  src="/porto.jpeg" 
                  alt="Akbar"
                  className="w-full h-full object-cover grayscale group-hover:grayscale-0 group-hover:scale-110 transition-all duration-700 font-sans"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-gray-950/50 to-transparent opacity-60"></div>
              </div>
              <div className="absolute -bottom-4 -right-4 w-12 h-12 bg-gray-900 border border-emerald-500/30 rounded-2xl flex items-center justify-center backdrop-blur-xl">
      ...
      {/* 4. ABOUT SECTION */}
      <section id="about" className="py-32 relative z-10 border-t border-gray-900/50">
        <div className="max-w-5xl mx-auto px-6 text-center">
          <motion.div {...fadeIn}>
            <h2 className="text-4xl font-bold mb-6 text-white">About <span className="text-emerald-400">Me</span></h2>
          ...
          <div className="mt-16 grid md:grid-cols-3 gap-6 text-left">
            {[
              ...
              <motion.div 
                ...
                className="bg-gray-900/40 border border-gray-800 rounded-2xl p-8 hover:border-emerald-500/30 transition-colors backdrop-blur-sm"
              >
      ...
      <section className="py-32 bg-gray-900/20 border-y border-gray-900/50 relative z-10">
        <div className="max-w-6xl mx-auto px-6 text-center">
          <h2 className="text-3xl font-bold mb-16">Tech <span className="text-emerald-400">Stack</span></h2>
          <div className="grid grid-cols-2 md:grid-cols-3 gap-10 text-left max-w-4xl mx-auto">
            <div>
      ...
      <section id="projects" className="py-32 relative z-10">
        <div className="max-w-6xl mx-auto px-6">
          <h2 className="text-4xl font-bold text-center mb-16 italic font-serif">Featured <span className="text-emerald-400 underline underline-offset-8 decoration-gray-900">Projects</span></h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {projectData.map((proj, i) => (
              <motion.div 
                key={i}
                whileHover={{ y: -10 }}
                className="group bg-gray-900/40 border border-gray-800 rounded-3xl p-8 hover:border-emerald-500/50 transition-all cursor-pointer flex flex-col justify-between"
              >
                <div>
                  <h3 className="text-2xl font-bold mb-2 group-hover:text-emerald-400 transition-colors">{proj.title}</h3>
      ...
      {/* 7. CONTACT SECTION */}
      <section id="contact" className="py-32 relative z-10 bg-emerald-500/5">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <motion.div {...fadeIn}>
            <h2 className="text-5xl font-bold mb-6 italic font-serif">Let's <span className="text-emerald-400 underline underline-offset-8 decoration-gray-800">Connect</span></h2>
            <p className="text-gray-400 mb-8 text-lg leading-relaxed max-w-lg mx-auto">Interested in collaboration or internship opportunities? Feel free to reach out.</p>
            
            <div className="flex flex-col items-center gap-8 mt-10">
              {/* Alamat Email Langsung */}
              <div className="group relative">
                <span className="text-2xl md:text-3xl font-mono font-bold text-gray-200 group-hover:text-emerald-400 transition-colors">
      ...
      {/* 8. FOOTER */}
      <footer className="py-12 text-center border-t border-gray-900/50 text-gray-600 text-[10px] tracking-[0.3em] uppercase">
